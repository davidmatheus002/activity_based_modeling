...
def non_mandatory_tour_frequency(persons, persons_merged,
    ...
    # if 'num_joint_tours' not in choosers:  # Added by David
    #     logger.warning("Column 'num_joint_tours' not in choosers table, assuming num_joint_tours = 0 for all choosers")
    #     choosers['num_joint_tours'] = 0
