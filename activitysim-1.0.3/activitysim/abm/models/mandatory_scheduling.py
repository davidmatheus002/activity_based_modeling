...
# Check indices on mandatory tours, see if it changes step by step
    ...
    # h.zhou 2021.9.17
    # mandatory_tours.loc[mandatory_tours.tour_type.isin(['univ', 'school']), 'activity_type'] = 5
    # mandatory_tours.loc[mandatory_tours.tour_type.isin(['work']), 'activity_type'] = 2
    # mandatory_tours['free_parking_cap'] = reindex(land_use.FreeParkingCapacity, mandatory_tours.destination)
