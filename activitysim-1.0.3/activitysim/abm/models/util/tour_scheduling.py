...
def run_tour_scheduling(model_name, chooser_tours, persons_merged, tdd_alts, tour_segment_col, chunk_size, trace_hh_id):
# Check index of chooser_tours
    ...
    if 'TOUR_SPEC_SEGMENTS' in model_settings:
        ...
        for spec_segment_name, spec_settings in spec_segment_settings.items():
            ...
            estimator = estimation.manager.begin_estimation(model_name=bundle_name, bundle_name=bundle_name)
    ...
    if estimators:
        # override choices for all estimators
        choices_list = []
